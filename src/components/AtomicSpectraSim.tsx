      ...
      <div className="space-y-4">
        <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-5 shadow-xl space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs text-zinc-400">{t.selectElementLabel}</label>
          ...
          <div className="space-y-1.5 pt-2 border-t border-zinc-800">
            <label className="text-xs text-zinc-400">{t.emissionLinesLabel}</label>
          ...
          {selectedElementId === 'hydrogen' && (
            <div className="space-y-1.5 pt-2 border-t border-zinc-800">
              <label className="text-xs text-zinc-400">{t.hydrogenTransitionLabel}</label>
