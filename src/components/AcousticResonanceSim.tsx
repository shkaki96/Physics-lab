...
import { Play, Pause, RotateCcw, BookmarkCheck, Volume2, VolumeX, Waves, Sparkles, Activity } from 'lucide-react';
            ...
            <div className="grid grid-cols-3 gap-1.5 text-xs">
              {resonantFrequencies.slice(0, 3).map((res) => (
                <button
                  ...
                  className="p-2 rounded-xl bg-zinc-950 border border-zinc-800 text-zinc-300 hover:bg-zinc-800 hover:text-teal-400 font-mono text-center"
                >
