...
import { Play, RotateCcw, PlusCircle, Check, Target, Flame } from 'lucide-react';
...
export default function ProjectileSim({ lang, onLogMeasurement }: Props) {
  const t = TRANSLATIONS[lang].experiments.projectile;
    ...
    <div id="projectile-simulation" className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-zinc-400">{ctrl.planetPreset}:</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          <div className="relative rounded-xl border border-zinc-800 bg-zinc-950/80 overflow-hidden shadow-inner flex flex-col items-center">
            ...
            {hitResult && (
              <div
                className={`absolute top-3 left-1/2 -translate-x-1/2 z-10 px-4 py-1.5 rounded-full text-xs font-semibold border flex items-center gap-2 shadow-lg ${
                  hitResult === 'hit'
                    ? 'bg-emerald-500/20 text-emerald-300 border-emerald-500/50'
                    : 'bg-amber-500/20 text-amber-300 border-amber-500/50'
                }`}
              >
                {hitResult === 'hit' ? t.hitTarget : t.missedTarget}
              </div>
            )}
            ...
            <div className="w-full border-t border-zinc-800/80 p-3 bg-zinc-900/40 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  onClick={handleReset}
                  className="px-3 py-1.5 rounded-lg border bg-zinc-800 text-zinc-300 border-zinc-700 hover:bg-zinc-700 transition-colors flex items-center gap-1"
                >
                ...
                <button
                  ...
                  disabled={isFlying}
                  className="px-4 py-1.5 rounded-lg bg-sky-600 hover:bg-sky-500 disabled:opacity-50 text-white font-medium flex items-center gap-1.5 shadow-md shadow-sky-600/30 transition-all"
                >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.range}</span>
            ...
            <div className="p-3 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.maxHeight}</span>
            ...
            <div className="p-3 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.flightTime}</span>
            ...
            <div className="p-3 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.vx} / {t.vy}</span>
          ...
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.velocity}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.angle}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.height}</span>
