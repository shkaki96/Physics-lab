...
import { Play, RotateCcw, PlusCircle, Check, Wind, Shield } from 'lucide-react';
...
export default function FreeFallSim({ lang, onLogMeasurement }: Props) {
  const t = TRANSLATIONS[lang].experiments.freefall;
          ...
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.dropHeight}</span>
