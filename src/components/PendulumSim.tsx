...
import { Play, Pause, RotateCcw, PlusCircle, Check, Info } from 'lucide-react';
...
export default function PendulumSim({ lang, onLogMeasurement }: Props) {
  const t = TRANSLATIONS[lang].experiments.pendulum;
    ...
    <div id="pendulum-simulation" className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          ...
          <div className="text-xs font-mono text-zinc-300 bg-zinc-900/90 border border-zinc-800 px-3 py-2 rounded-xl flex items-center justify-between gap-2 shadow-sm">
            <div className="flex items-center gap-2">
              <Info className="w-4 h-4 text-sky-400 shrink-0" />
              <span>{t.dragToAngle}</span>
            </div>
            ...
            <div className="w-full border-t border-zinc-800/80 p-3 bg-zinc-900/40 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="p-2 rounded-lg border bg-zinc-800 text-zinc-300 border-zinc-700 hover:bg-zinc-700 transition-colors"
                  title={ctrl.reset}
                >
          ...
          {showEnergyBars && (
            <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-900/50 space-y-3">
              <div className="flex items-center justify-between text-xs">
                <span className="font-medium text-zinc-200">{t.totalEnergy}: {liveStats.Etotal.toFixed(2)} J</span>
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.period}</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.frequency}</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.maxVelocity}</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.oscillations}</span>
          ...
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.length}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.mass}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.gravity}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.initialAngle}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.damping}</span>
