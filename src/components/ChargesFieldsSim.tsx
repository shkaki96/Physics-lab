...
import { Sparkles, Plus, Minus, RotateCcw, Activity } from 'lucide-react';
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => addCharge(1)}
                className="flex items-center justify-center gap-1.5 p-2 bg-red-600/20 hover:bg-red-600/30 text-red-300 border border-red-500/40 rounded-lg text-xs font-bold transition-colors"
              >
              ...
              <button
                onClick={() => addCharge(-1)}
                className="flex items-center justify-center gap-1.5 p-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 border border-blue-500/40 rounded-lg text-xs font-bold transition-colors"
              >
