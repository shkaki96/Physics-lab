        ...
        <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-base sm:text-lg font-medium text-zinc-100 leading-relaxed">
              {lang === 'ar' 
                ? question.questionAr 
                : lang === 'kmr'
                ? (question.questionKmr || question.questionKu || question.questionEn)
                : lang === 'ku'
                ? (question.questionKu || question.questionEn) 
                : question.questionEn}
            </h3>
          </div>
          ...
          <div className="space-y-2.5">
            {(lang === 'ar' 
              ? question.optionsAr 
              : lang === 'kmr' 
              ? (question.optionsKmr || question.optionsKu || question.optionsEn)
              : lang === 'ku' 
              ? (question.optionsKu || question.optionsEn) 
            ...
            <div className="p-4 rounded-xl bg-zinc-950/80 border border-zinc-800 space-y-1.5 text-xs">
              ...
              <p className="text-zinc-300 leading-relaxed">
                {lang === 'ar' 
                  ...
                  : lang === 'kmr'
                  ? (question.explanationKmr || question.explanationKu || question.explanationEn)
                  : lang === 'ku'
                  ? (question.explanationKu || question.explanationEn) 
