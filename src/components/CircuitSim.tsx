...
import { PlusCircle, Check, Zap, Power, Activity } from 'lucide-react';
...
export default function CircuitSim({ lang, onLogMeasurement }: Props) {
  const t = TRANSLATIONS[lang].experiments.circuits;
    ...
    <div id="circuit-simulation" className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
        ...
        >
          ...
          <span>{isSwitchClosed ? t.switchOn : t.switchOff}</span>
        </button>
      </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          <div className="relative rounded-xl border border-zinc-800 bg-zinc-950/80 overflow-hidden shadow-inner flex flex-col items-center">
            ...
            <div className="w-full border-t border-zinc-800/80 p-3 bg-zinc-900/40 flex flex-wrap items-center justify-between gap-3 text-xs">
              <label className="flex items-center gap-1.5 cursor-pointer text-zinc-300">
                ...
                <span>{t.electronFlow}</span>
              </label>

              <div className="flex items-center gap-2">
                <span className="text-zinc-400">{t.circuitType}:</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.current} (I)</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.totalResistance}</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.power} (P)</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.voltage}</span>
          ...
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.voltage}</span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.resistance1}</span>
            ...
            {circuitType !== 'single' && (
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-zinc-300">{t.resistance2}</span>
