...
import { Play, Pause, RotateCcw, BookmarkCheck, Gauge, Zap, Sparkles, Scale, RefreshCw } from 'lucide-react';
      ...
      <div className="lg:col-span-8 space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-2xl bg-zinc-900/80 border border-zinc-800">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>{isRunning ? controls.pause : t.launchCarts}</span>
            </button>

            <button
              id="collision-reset-btn"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3 rounded-xl bg-zinc-900/70 border border-zinc-800 font-mono">
            <span className="text-[10px] text-zinc-400 block">{t.totalMomentumBefore}</span>
            <span className="text-sm font-bold text-sky-400">{initialMomentum.toFixed(2)} kg·m/s</span>
          </div>

          <div className="p-3 rounded-xl bg-zinc-900/70 border border-zinc-800 font-mono">
            <span className="text-[10px] text-zinc-400 block">{t.totalMomentumAfter}</span>
          ...
          <div className="p-3 rounded-xl bg-zinc-900/70 border border-zinc-800 font-mono">
            <span className="text-[10px] text-zinc-400 block">{t.keInitial}</span>
            <span className="text-sm font-bold text-indigo-400">{initialKE.toFixed(2)} J</span>
          </div>

          <div className="p-3 rounded-xl bg-zinc-900/70 border border-zinc-800 font-mono">
            <span className="text-[10px] text-zinc-400 block">{t.keLost}</span>
        ...
        <div className="p-4 rounded-2xl bg-zinc-900/80 border border-zinc-800 space-y-4">
          ...
          <div className="space-y-1.5 pt-1">
            <div className="flex justify-between text-xs">
              <span className="text-zinc-400">{t.elasticity}</span>
