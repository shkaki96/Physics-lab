...
import { PlusCircle, Check, Sparkles, AlertTriangle, Eye } from 'lucide-react';
...
export default function OpticsSim({ lang, onLogMeasurement }: Props) {
  const t = TRANSLATIONS[lang].experiments.optics;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.refractedAngle} (θ₂)</span>
            ...
            <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/60">
              <span className="text-[11px] text-zinc-400 block">{t.criticalAngle} (θ_c)</span>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="p-5 rounded-xl border border-zinc-800 bg-zinc-900/40 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs text-zinc-300">{t.medium1}</label>
              <select
                id="select-medium1"
                value={medium1Id}
            ...
            {/* Medium 2 Select */}
            <div className="space-y-1.5">
              <label className="text-xs text-zinc-300">{t.medium2}</label>
              <select
                id="select-medium2"
                value={medium2Id}
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs">
                <span className="text-zinc-300">{t.incidentAngle}</span>
            ...
            {/* Laser Color Palette */}
            <div className="space-y-1.5">
              <label className="text-xs text-zinc-300">{t.laserColor}</label>
              <div className="flex items-center gap-2">
                {[
